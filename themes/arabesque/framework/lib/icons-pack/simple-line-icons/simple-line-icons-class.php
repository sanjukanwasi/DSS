...
if ( ! function_exists( 'arabesque_mikado_add_simple_line_icon_pack' ) ) {
	function arabesque_mikado_add_simple_line_icon_pack( $iconCollections ) {
		$iconCollections['simple_line_icons'] = new ArabesqueMikadoSimpleLineIcons( 'Simple Line Icons', 'simple_line_icon' );

		return $iconCollections;
	}

	add_filter( 'arabesque_mikado_filter_add_icon_pack_into_collection', 'arabesque_mikado_add_simple_line_icon_pack' );
}

if ( ! function_exists( 'arabesque_mikado_add_simple_line_icon_pack_option' ) ) {
	function arabesque_mikado_add_simple_line_icon_pack_option( $options ) {
		$options['simple_line_icons'] = esc_html__( 'Simple Line Icons', 'arabesque' );

		return $options;
	}

	add_filter( 'arabesque_mikado_filter_add_icon_pack_into_options', 'arabesque_mikado_add_simple_line_icon_pack_option' );
	add_filter( 'arabesque_mikado_filter_add_icon_pack_into_social_options', 'arabesque_mikado_add_simple_line_icon_pack_option' );
}

class ArabesqueMikadoSimpleLineIcons implements iArabesqueMikadoIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
	...
	public function setSocialIconsArray() {
		$this->socialIcons = array(
			''                        => '',
			'icon-social-behance'     => esc_html__( 'Behance', 'arabesque' ),
			'icon-social-dribbble'    => esc_html__( 'Dribbble', 'arabesque' ),
			'icon-social-dropbox'     => esc_html__( 'Dropbox', 'arabesque' ),
			'icon-social-facebook'    => esc_html__( 'Facebook', 'arabesque' ),
			'icon-social-foursquare'  => esc_html__( 'Foursquare', 'arabesque' ),
			'icon-social-github'      => esc_html__( 'Github', 'arabesque' ),
			'icon-social-gplus'       => esc_html__( 'Google Plus', 'arabesque' ),
			'icon-social-instagram'   => esc_html__( 'Instagram', 'arabesque' ),
			'icon-social-linkedin'    => esc_html__( 'LinkedIn', 'arabesque' ),
			'icon-social-pintarest'   => esc_html__( 'Pinterest', 'arabesque' ),
			'icon-social-reddit'      => esc_html__( 'Reddit', 'arabesque' ),
			'icon-social-skype'       => esc_html__( 'Skype', 'arabesque' ),
			'icon-social-soundcloud'  => esc_html__( 'Soundcloud', 'arabesque' ),
			'icon-social-stumbleupon' => esc_html__( 'Stumbleupon', 'arabesque' ),
			'icon-social-spotify'     => esc_html__( 'Spotify', 'arabesque' ),
			'icon-social-tumblr'      => esc_html__( 'Tumblr', 'arabesque' ),
			'icon-social-twitter'     => esc_html__( 'Twitter', 'arabesque' ),
			'icon-social-youtube'     => esc_html__( 'Youtube', 'arabesque' )
		);
	}
