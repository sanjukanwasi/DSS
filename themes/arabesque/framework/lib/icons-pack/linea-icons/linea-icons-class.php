...
if ( ! function_exists( 'arabesque_mikado_add_linea_icon_pack' ) ) {
	function arabesque_mikado_add_linea_icon_pack( $iconCollections ) {
		$iconCollections['linea_icons'] = new ArabesqueMikadoLineaIcons( 'Linea Icons', 'linea_icon' );

		return $iconCollections;
	}

	add_filter( 'arabesque_mikado_filter_add_icon_pack_into_collection', 'arabesque_mikado_add_linea_icon_pack' );
}

if ( ! function_exists( 'arabesque_mikado_add_linea_icon_pack_option' ) ) {
	function arabesque_mikado_add_linea_icon_pack_option( $options ) {
		$options['linea_icons'] = esc_html__( 'Linea Icons', 'arabesque' );

		return $options;
	}

	add_filter( 'arabesque_mikado_filter_add_icon_pack_into_options', 'arabesque_mikado_add_linea_icon_pack_option' );
}

class ArabesqueMikadoLineaIcons implements iArabesqueMikadoIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
