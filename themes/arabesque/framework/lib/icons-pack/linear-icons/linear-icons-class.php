...
if ( ! function_exists( 'arabesque_mikado_add_linear_icon_pack' ) ) {
	function arabesque_mikado_add_linear_icon_pack( $iconCollections ) {
		$iconCollections['linear_icons'] = new ArabesqueMikadoLinearIcons( 'Linear Icons', 'linear_icon' );

		return $iconCollections;
	}

	add_filter( 'arabesque_mikado_filter_add_icon_pack_into_collection', 'arabesque_mikado_add_linear_icon_pack' );
}

if ( ! function_exists( 'arabesque_mikado_add_linear_icon_pack_option' ) ) {
	function arabesque_mikado_add_linear_icon_pack_option( $options ) {
		$options['linear_icons'] = esc_html__( 'Linear Icons', 'arabesque' );

		return $options;
	}

	add_filter( 'arabesque_mikado_filter_add_icon_pack_into_options', 'arabesque_mikado_add_linear_icon_pack_option' );
}

class ArabesqueMikadoLinearIcons implements iArabesqueMikadoIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
