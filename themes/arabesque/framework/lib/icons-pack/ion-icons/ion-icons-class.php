...
if ( ! function_exists( 'arabesque_mikado_add_ion_icon_pack' ) ) {
	function arabesque_mikado_add_ion_icon_pack( $iconCollections ) {
		$iconCollections['ion_icons'] = new ArabesqueMikadoIonIcons( 'Ion Icons', 'ion_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'arabesque_mikado_filter_add_icon_pack_into_collection', 'arabesque_mikado_add_ion_icon_pack' );
}

if ( ! function_exists( 'arabesque_mikado_add_ion_icon_pack_option' ) ) {
	function arabesque_mikado_add_ion_icon_pack_option( $options ) {
		$options['ion_icons'] = esc_html__( 'Ion Icons', 'arabesque' );
		
		return $options;
	}
	
	add_filter( 'arabesque_mikado_filter_add_icon_pack_into_options', 'arabesque_mikado_add_ion_icon_pack_option' );
	add_filter( 'arabesque_mikado_filter_add_icon_pack_into_social_options', 'arabesque_mikado_add_ion_icon_pack_option' );
}

class ArabesqueMikadoIonIcons implements iArabesqueMikadoIconCollection {
	public $icons;
	public $socialIcons;
    public $title;
	public $param;
