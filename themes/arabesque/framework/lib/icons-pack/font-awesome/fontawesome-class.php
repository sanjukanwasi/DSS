...
if ( ! function_exists( 'arabesque_mikado_add_font_awesome_icon_pack' ) ) {
	function arabesque_mikado_add_font_awesome_icon_pack( $iconCollections ) {
		$iconCollections['font_awesome'] = new ArabesqueMikadoIconsFontAwesome( 'Font Awesome', 'fa_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'arabesque_mikado_filter_add_icon_pack_into_collection', 'arabesque_mikado_add_font_awesome_icon_pack' );
}

if ( ! function_exists( 'arabesque_mikado_add_font_awesome_icon_pack_option' ) ) {
	function arabesque_mikado_add_font_awesome_icon_pack_option( $options ) {
		$options['font_awesome'] = esc_html__( 'Font Awesome', 'arabesque' );
		
		return $options;
	}
	
	add_filter( 'arabesque_mikado_filter_add_icon_pack_into_options', 'arabesque_mikado_add_font_awesome_icon_pack_option' );
	add_filter( 'arabesque_mikado_filter_add_icon_pack_into_social_options', 'arabesque_mikado_add_font_awesome_icon_pack_option' );
}

class ArabesqueMikadoIconsFontAwesome implements iArabesqueMikadoIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
