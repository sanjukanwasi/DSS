...
if ( ! function_exists( 'arabesque_mikado_add_dripicons_icon_pack' ) ) {
	function arabesque_mikado_add_dripicons_icon_pack( $iconCollections ) {
		$iconCollections['dripicons'] = new ArabesqueMikadoDripicons( 'Dripicons', 'dripicon' );

		return $iconCollections;
	}

	add_filter( 'arabesque_mikado_filter_add_icon_pack_into_collection', 'arabesque_mikado_add_dripicons_icon_pack' );
}

if ( ! function_exists( 'arabesque_mikado_add_dripicons_icon_pack_option' ) ) {
	function arabesque_mikado_add_dripicons_icon_pack_option( $options ) {
		$options['dripicons'] = esc_html__( 'Dripicons', 'arabesque' );

		return $options;
	}

	add_filter( 'arabesque_mikado_filter_add_icon_pack_into_options', 'arabesque_mikado_add_dripicons_icon_pack_option' );
}

class ArabesqueMikadoDripicons implements iArabesqueMikadoIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
