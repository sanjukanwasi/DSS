<div class="mkdf-tabs-navigation-wrapper">
    <ul class="nav nav-tabs">
	    ...
	    <?php if ( arabesque_mikado_is_plugin_installed( 'core' ) ) { ?>
	        ...
	        <li <?php if($isImportPage) { echo "class='active'"; } ?>><a href="<?php echo esc_url(get_admin_url().'admin.php?page='.MIKADO_OPTIONS_SLUG.'_tabimport'); ?>"><i class="fa fa-download mkdf-tooltip mkdf-inline-tooltip left" data-placement="top" data-toggle="tooltip" title="<?php esc_attr_e('Import','arabesque'); ?>"></i><span><?php esc_html_e('Import','arabesque'); ?></span></a></li>
	    <?php } ?>
    </ul>
</div>