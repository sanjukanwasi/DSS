...
if ( ! function_exists('arabesque_mikado_breadcrumbs_title_type_options_map') ) {
	function arabesque_mikado_breadcrumbs_title_type_options_map($panel_typography) {
		
		arabesque_mikado_add_admin_section_title(
			array(
				'name'   => 'type_section_breadcrumbs',
				'title'  => esc_html__( 'Breadcrumbs', 'arabesque' ),
				'parent' => $panel_typography
			)
		);
	
		$group_page_breadcrumbs_styles = arabesque_mikado_add_admin_group(
			array(
				'name'        => 'group_page_breadcrumbs_styles',
				'title'       => esc_html__( 'Breadcrumbs', 'arabesque' ),
				'description' => esc_html__( 'Define styles for page breadcrumbs', 'arabesque' ),
				'parent'      => $panel_typography
			)
		);
	
			$row_page_breadcrumbs_styles_1 = arabesque_mikado_add_admin_row(
				array(
			...
			$row_page_breadcrumbs_styles_2 = arabesque_mikado_add_admin_row(
				array(
			...
			$row_page_breadcrumbs_styles_3 = arabesque_mikado_add_admin_row(
				array(
	...
	add_action( 'arabesque_mikado_action_additional_title_typography_options_map', 'arabesque_mikado_breadcrumbs_title_type_options_map');
}