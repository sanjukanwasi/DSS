...
if ( ! class_exists( 'ArabesqueMikadoStickyNavigationWalker' ) ) {
	class ArabesqueMikadoStickyNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if ( $depth == 0 ) {
				if ( $item->type_menu == "wide" ) {
					...
					$wide_type = arabesque_mikado_options()->getOptionValue( 'wide_dropdown_style' );
					if ( $wide_type !== '' ) {
