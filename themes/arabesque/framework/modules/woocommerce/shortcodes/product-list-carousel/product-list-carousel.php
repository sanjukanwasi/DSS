...
namespace ArabesqueCore\CPT\Shortcodes\ProductListCarousel;
...
class ProductListCarousel implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Product List - Carousel', 'arabesque' ),
					'base'                      => $this->base,
					...
					'params'                    => array(
						array(
							...
							'value'       => array(
								...
								esc_html__( 'Simple', 'arabesque' )   => 'simple'
							),
							'save_always' => true
						),
						array(
						...
						array(
							...
							'heading'     => esc_html__( 'Number Of Visible Items', 'arabesque' ),
							'value'       => array(
							...
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'arabesque' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'slider_loop',
							'heading'     => esc_html__( 'Enable Slider Loop', 'arabesque' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Autoplay', 'arabesque' ),
							'value'       => array_flip( arabesque_mikado_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'arabesque' )
						),
						array(
							...
							'heading'     => esc_html__( 'Slide Duration', 'arabesque' ),
							'description' => esc_html__( 'Default value is 5000 (ms)', 'arabesque' ),
							'group'       => esc_html__( 'Slider Settings', 'arabesque' )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'slider_speed_animation',
							'heading'     => esc_html__( 'Slide Animation Duration', 'arabesque' ),
							'description' => esc_html__( 'Speed of slide animation in milliseconds. Default value is 600.', 'arabesque' ),
							'group'       => esc_html__( 'Slider Settings', 'arabesque' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'slider_navigation',
							'heading'     => esc_html__( 'Enable Slider Navigation Arrows', 'arabesque' ),
							'value'       => array_flip( arabesque_mikado_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'arabesque' )
						),
						array(
							...
							'heading'    => esc_html__( 'Slider Navigation Skin', 'arabesque' ),
							'value'      => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Pagination', 'arabesque' ),
							'value'       => array_flip( arabesque_mikado_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'arabesque' )
						),
						array(
							...
							'heading'    => esc_html__( 'Slider Pagination Skin', 'arabesque' ),
							'value'      => array(
								esc_html__( 'Default', 'arabesque' ) => 'default',
								esc_html__( 'Light', 'arabesque' )   => 'light'
							),
						...
						array(
							...
							'heading'    => esc_html__( 'Slider Pagination Position', 'arabesque' ),
							'value'      => array(
								esc_html__( 'Below Carousel', 'arabesque' )  => 'bellow-slider',
								esc_html__( 'Inside Carousel', 'arabesque' ) => 'inside-slider'
							),
							'dependency' => array( 'element' => 'slider_pagination', 'value' => array( 'yes' ) ),
							'group'      => esc_html__( 'Slider Settings', 'arabesque' )
						),
	...
	public function render( $atts, $content = null ) {
		...
		$html = arabesque_mikado_get_woo_shortcode_module_template_part( 'templates/product-list', 'product-list-carousel', $params['type'], $params, $additional_params );
