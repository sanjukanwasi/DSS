...
if ( ! function_exists( 'arabesque_mikado_get_search' ) ) {
	...
	add_action( 'arabesque_mikado_action_before_page_header', 'arabesque_mikado_get_search' );
}
...
if ( ! function_exists( 'arabesque_mikado_load_search_template' ) ) {
	...
	function arabesque_mikado_load_search_template() {
		$parameters = array(
			...
			'search_submit_icon_class' 	=> arabesque_mikado_get_search_submit_icon_class()
		);

        arabesque_mikado_get_module_template_part( 'types/fullscreen/templates/fullscreen', 'search', '', $parameters );
	}
}